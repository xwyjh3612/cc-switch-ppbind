...
[Vollständiges Changelog](../../CHANGELOG.md) | [Release Notes](../release-notes/v3.16.1-en.md)
...
Ausführliche Anleitungen zu jeder Funktion finden Sie im **[Benutzerhandbuch](../user-manual/en/README.md)** — es deckt Anbieterverwaltung, MCP/Prompts/Skills, Proxy & Failover und mehr ab.
