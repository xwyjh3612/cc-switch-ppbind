...
[Full Changelog](../../CHANGELOG.md) | [Release Notes](../release-notes/v3.16.1-en.md)
...
For detailed guides on every feature, check out the **[User Manual](../user-manual/en/README.md)** — covering provider management, MCP/Prompts/Skills, proxy & failover, and more.
