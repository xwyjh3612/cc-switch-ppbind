...
/// 将 `/path/to/PPBind.app/Contents/MacOS/PPBind` 转换为 `/path/to/PPBind.app`
#[cfg(target_os = "macos")]
...
mod tests {
    ...
    fn test_get_macos_app_bundle_path_valid() {
        let exe_path = std::path::Path::new("/Applications/PPBind.app/Contents/MacOS/PPBind");
        let result = get_macos_app_bundle_path(exe_path);
        assert_eq!(
            result,
            Some(std::path::PathBuf::from("/Applications/PPBind.app"))
        );
    }
    ...
    fn test_get_macos_app_bundle_path_with_spaces() {
        let exe_path = std::path::Path::new("/Users/test/My Apps/PPBind.app/Contents/MacOS/PPBind");
        let result = get_macos_app_bundle_path(exe_path);
        assert_eq!(
            result,
            Some(std::path::PathBuf::from("/Users/test/My Apps/PPBind.app"))
        );
    }
