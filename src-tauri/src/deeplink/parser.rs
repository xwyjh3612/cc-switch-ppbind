...
//!
//! Parses ppbind:// URLs into DeepLinkImportRequest structures.
...
/// Parse a ppbind:// URL into a DeepLinkImportRequest
///
/// Expected format:
/// ppbind://v1/import?resource={type}&...
pub fn parse_deeplink_url(url_str: &str) -> Result<DeepLinkImportRequest, AppError> {
    ...
    if scheme != "ppbind" {
        return Err(AppError::InvalidInput(format!(
            "Invalid scheme: expected 'ppbind', got '{scheme}'"
        )));
    }
